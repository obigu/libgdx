...
public class IOSGLES30 extends IOSGLES20 implements GL30 {
    ...
    public native void glTexImage3DJNI(int target, int level, int internalformat, int width, int height, int depth, int border, int format, int type, Buffer pixels);
    ...
    public native void glTexSubImage3DJNI(int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int type, Buffer pixels);
