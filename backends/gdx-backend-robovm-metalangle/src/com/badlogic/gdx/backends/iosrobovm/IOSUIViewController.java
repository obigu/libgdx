...
public class IOSUIViewController extends MGLKViewController {
    ...
    public void keyboardWillShow(NSNotification notification) {
        ...
        newFrame.setOrigin(new CGPoint(getView().getSafeAreaInsets().getLeft(), getView().getBounds().getSize().getHeight() - keyboardEndFrame.getSize().getHeight() - newFrame.getSize().getHeight()));
        newFrame.setSize(new CGSize(getView().getBounds().getSize().getWidth() - getView().getSafeAreaInsets().getLeft() - getView().getSafeAreaInsets().getRight(), newFrame.getSize().getHeight()));
    ...
    public void injectKeyboardNotification() {
        NSNotificationCenter.getDefaultCenter().addObserver(this, Selector.register("keyboardWillShow"), UIWindow.KeyboardWillShowNotification(), null);
        NSNotificationCenter.getDefaultCenter().addObserver(this, Selector.register("keyboardWillHide"), UIWindow.KeyboardWillHideNotification(), null);
    }
