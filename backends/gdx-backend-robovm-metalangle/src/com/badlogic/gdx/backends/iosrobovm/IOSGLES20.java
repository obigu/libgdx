...
public class IOSGLES20 implements GL20 {
    ...
    final boolean shouldConvert16bit = IOSApplication.IS_METALANGLE && NSProcessInfo.getSharedProcessInfo().getEnvironment().containsKey("SIMULATOR_DEVICE_NAME");
    ...
    public native void glTexImage2DJNI(int target, int level, int internalformat, int width, int height, int border, int format, int type, Buffer pixels);
    ...
    public native void glTexSubImage2DJNI(int target, int level, int xoffset, int yoffset, int width, int height, int format, int type, Buffer pixels);
