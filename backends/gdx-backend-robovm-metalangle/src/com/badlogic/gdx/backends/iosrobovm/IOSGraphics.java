...
public class IOSGraphics extends AbstractGraphics {
    ...
    public DisplayMode getDisplayMode() {
        return new IOSDisplayMode(getWidth(), getHeight(), (int) (viewController.getPreferredFramesPerSecond()), bufferFormat.r + bufferFormat.g + bufferFormat.b + bufferFormat.a);
    }
